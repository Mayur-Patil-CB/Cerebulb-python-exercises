# Generated by Django 5.1.1 on 2025-07-01 11:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_type', models.CharField(blank=True, choices=[('IN', 'Indian'), ('CH', 'Chinese'), ('IT', 'Italian'), ('GR', 'Greek'), ('MX', 'Mexican'), ('FF', 'Fast Food'), ('OT', 'Other')], max_length=2, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='core.restaurant')),
            ],
        ),
        migrations.CreateModel(
